...
if __name__ == '__main__':
    ...
    parser.add_argument('-dataset', '--dataset', type=str, default='DBLP',
    ...
    for l in range(1):
        ...
        if adaptive_lr == 'False':
            ...
            optimizer = torch.optim.Adam([{'params': model.weight},
                                          ...
                                          {'params': model.DGCN.parameters(), "lr": 0.01, "weight_decay": 0.00001},
